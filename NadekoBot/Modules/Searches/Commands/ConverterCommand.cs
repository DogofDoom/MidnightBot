    ...
    class ConverterCommand : DiscordCommand
    {
        ...
        internal override void Init ( CommandGroupBuilder cgb )
        {
            cgb.CreateCommand (Module.Prefix + "convert")
                .Description ("Konvertiert Einheiten von>zu. Beispiel: `~convert m>km 1000`")
            ...
            cgb.CreateCommand (Module.Prefix + "convertlist")
                .Description ("Liste der kovertierbaren Dimensionen und Währungen.")
                .Do (ConvertListFunc ());
        }
        ...
        private Func<CommandEventArgs,Task> ConvertFunc () =>
            async e =>
            {
                ...
                catch //(Exception ex)
                {
                    ...
                    await e.Channel.SendMessage ("Falsches Eingabeformat, oder etwas ist falsch gelaufen... Versuche es mit `" + Module.Prefix + "`convertlist").ConfigureAwait (false);
                }
            };
