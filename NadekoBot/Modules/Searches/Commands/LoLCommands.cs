                  ...
                  .Do(async e => 
                  {
                      try
                      {
                          ...
                          if (role != null)
                          {
                              ...
                              if (data == null)
                              {
                                  await e.Channel.SendMessage("💢 Daten für diese Rolle existieren nicht.").ConfigureAwait (false);
                                  return;
                              }
                          }
                          else
                          ...
                          if (champ != null)
                          {
                              Console.WriteLine("Sendet LOL Bild aus dem Cache.");
                              champ.ImageStream.Position = 0;
                              await e.Channel.SendFile("champ.png", champ.ImageStream).ConfigureAwait (false);
                              return;
                          }
                      ...
                      {
                          await e.Channel.SendMessage("💢 Daten für Champion konnten nicht abgerufen werden.").ConfigureAwait (false);
                      }
                  });

            cgb.CreateCommand(Module.Prefix + "lolban")
                  .Description("Zeigt die Top 12 gebannten LOL Champs. Banne diese 5 Champions und du wirst in kürzester Zeit Plat5 sein.")
                  .Do(async e => 
                  {
                      ...
                      {
                          await e.Channel.SendMessage($":anger: Fail: Champion.gg disabled ban data until next patch. Sorry for the inconvenience.").ConfigureAwait (false);
                      }
                  });
        }
