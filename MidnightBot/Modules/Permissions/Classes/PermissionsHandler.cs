...
namespace MidnightBot.Modules.Permissions.Classes
{
    public static class PermissionsHandler
    {
        ...
        {
            Console.WriteLine ("Berechtigungsdateien werden gelesen.");
            ...
            foreach (var file in Directory.EnumerateFiles ("data/permissions/"))
            {
                try
                {
                    ...
                    if (string.IsNullOrWhiteSpace (strippedFileName))
                        continue;
            ...
            Console.WriteLine ("Rechte vollständig initialisiert.");
        }
    ...
    public class Permissions
    {
        ...
        /// </summary>
        public ConcurrentDictionary<string,bool> Modules
        {
            get; set;
        }
        /// <summary>
        ...
        /// </summary>
        public ConcurrentDictionary<string,bool> Commands
        {
            get; set;
        }
        /// <summary>
    ...
    public class ServerPermissions
    {
        ...
        {
            Id = id;
            PermissionsControllerRole = "Admin";
            Verbose = true;
