...
### [Click here to invite Midnight to your server](https://discordapp.com/oauth2/authorize?client_id=170254782546575360&scope=bot&permissions=66186303)
...
#### For easy setup and no programming knowledge, you can use [UPDATER](https://github.com/Midnight-Myth/MidnightUpdater/releases/latest) or download release from [releases](https://github.com/Midnight-Myth/MidnightBot/releases) and follow the comprehensive [GUIDE](https://github.com/Midnight-Myth/MidnightBot/blob/master/ComprehensiveGuide.md)
